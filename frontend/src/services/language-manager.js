...
export function initializeLanguageManager() {
    ...
    if (window.languageManager instanceof LanguageManager) {
        languageManagerInstance = window.languageManager;
        return languageManagerInstance;
    }

    languageManagerInstance = new LanguageManager();
    window.languageManager = languageManagerInstance;
    return languageManagerInstance;
}

export function getLanguageManager() {
    return languageManagerInstance || window.languageManager || null;
}
